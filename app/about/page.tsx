        ...
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          ...
          <div className="space-y-12 max-w-none">
            <p className="text-xl text-muted-foreground leading-relaxed">
              I'm Nirmal Rathod, a Product Designer and Web Developer based in Gujarat. I specialize
              in bridging the gap between aesthetics and functionality, creating digital experiences
              that are not just visually stunning, but inherently useful and conversion-focused.
            </p>
